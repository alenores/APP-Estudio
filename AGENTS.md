...
components/desktop/                  → UI exclusiva escritorio (explorador, modales, toolbar)
lib/explorer-card-meta.ts            → métricas compactas en cards PC
components/study/forms/tema-form.tsx → alta tema (shared móvil + PC)
